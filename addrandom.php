...
$mform = new quiz_add_random_form(new moodle_url('/mod/hippotrack/addrandom.php'),
...
echo $OUTPUT->heading(get_string('addrandomquestiontoquiz', 'hippotrack', $quizname), 2);
$mform->display();
echo $OUTPUT->footer();
