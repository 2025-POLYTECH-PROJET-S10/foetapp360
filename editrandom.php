...
if (!$quiz = $DB->get_record('hippotrack', ['id' => $slot->quizid])) {
    new moodle_exception('invalidquizid', 'hippotrack');
}

$cm = get_coursemodule_from_instance('hippotrack', $slot->quizid, $quiz->course);
